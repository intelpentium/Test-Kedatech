package kedaiapps.projeku.testandroidkedatech.common

sealed class UiState {
    object Loading : UiState()
    object Success : UiState()
    class Error(val message: String) : UiState()
    class Failed(val code: String, val message: String) : UiState()
}
...
sealed class UiState2 {
    ...
    class Failed(val code: String, val message: String) : UiState2()
}
